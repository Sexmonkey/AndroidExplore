...
public class Constants {
     ...
     * Path
     */
    public static final String PATH_DATA = AndroidExploreApp.getInstance().getCacheDir().getAbsolutePath() + File.separator + "data";
    ...
    static final String DB_NAME = "android_explore.db";
