...
public class CommonUtils {
    ...
    public static int dp2px(float dpValue) {
        final float scale = AndroidExploreApp.getInstance().getResources().getDisplayMetrics().density;
    ...
    public static boolean isNetworkConnected() {
        ConnectivityManager connectivityManager = (ConnectivityManager) AndroidExploreApp.getInstance().getApplicationContext().getSystemService(Context.CONNECTIVITY_SERVICE);
